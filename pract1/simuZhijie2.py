...
# for alpha in [0.001, 0.003, 0.01, 0.03, 0.1, 0.2, 0.3]:
#     print(f"Adaline, umbral {umbral}, epocas {epocas}, alpha {alpha}")
#     os.system(f'python adaline.py --modo3 data/problema_real2.txt data/problema_real2_no_etiquetados.txt --f_out output/parameter_tuning/problema2/adaline/output_umbral{umbral}_epocas{epocas}_alpha{alpha}.txt --umbral {umbral} --alpha {alpha} --torelancia 0.001 --epoca {epocas}')
